        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MedicalItemType = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    LastUpdatedBy = table.Column<int>(type: "int", nullable: true),
                    DeletedBy = table.Column<int>(type: "int", nullable: true),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundStatus = table.Column<bool>(type: "bit", nullable: true),
                    OnlinePaymentStatus = table.Column<bool>(type: "bit", nullable: true),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalizationDateStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentStaffId = table.Column<int>(type: "int", nullable: true),
                    ...
                    RefundPaymentId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, null, null, null, "5f43d814-d158-46be-a922-8216308cc998", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 56, 811, DateTimeKind.Unspecified).AddTicks(1599), new TimeSpan(0, 7, 0, 0, 0)), null, null, "admin@email.com", false, "Admin User", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 56, 811, DateTimeKind.Unspecified).AddTicks(1599), new TimeSpan(0, 7, 0, 0, 0)), false, null, null, "ADMIN", null, null, "$2a$11$t8v84aGEKWQmO4so4FpUMO2RLY8c3ELcIGXsuUnfwiovmB1etgrb6", null, false, false, "admin", null },
                    { 2, 0, null, null, null, "92081f71-f155-4bbb-98a4-88e16a56fcf9", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 56, 942, DateTimeKind.Unspecified).AddTicks(9619), new TimeSpan(0, 7, 0, 0, 0)), null, null, "staff@email.com", false, "Staff User", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 56, 942, DateTimeKind.Unspecified).AddTicks(9619), new TimeSpan(0, 7, 0, 0, 0)), false, null, null, "staff", null, null, "$2a$11$.z6v0EhvzMDUFnsd/xBIzePAMJrcKp5is/7KbO.mi1zfEyWGq7s8K", null, false, false, "staff", null },
                    { 3, 0, "123 Main St", null, new DateTimeOffset(new DateTime(1985, 6, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "ad8c146a-da17-47cf-858f-d9f5c2cf2cf6", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 72, DateTimeKind.Unspecified).AddTicks(2857), new TimeSpan(0, 7, 0, 0, 0)), null, null, "johndoe@example.com", false, "John Doe", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 72, DateTimeKind.Unspecified).AddTicks(2857), new TimeSpan(0, 7, 0, 0, 0)), false, null, null, "JOHNDOE", null, null, "$2a$11$njTM8AZEbDEOFv66tft5g.V4voQCOqNX2DXnQ6XRGH0eEoxtDsCou", null, false, false, "vet1", null },
                    { 4, 0, "456 Elm St", null, new DateTimeOffset(new DateTime(1990, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "c84aebf5-3700-4d5f-9c0e-7879212679f8", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 199, DateTimeKind.Unspecified).AddTicks(4528), new TimeSpan(0, 7, 0, 0, 0)), null, null, "janesmith@example.com", false, "Jane Smith", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 199, DateTimeKind.Unspecified).AddTicks(4528), new TimeSpan(0, 7, 0, 0, 0)), false, null, null, "JANESMITH", null, null, "$2a$11$zlZ.wgWphuI8EVb1MXRnBerXCGpQSjJWFJ3iAuzwOnPtb0cAIcvR2", null, false, false, "vet2", null },
                    { 5, 0, "789 Pine St", null, new DateTimeOffset(new DateTime(1978, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "e94228af-c90a-4c84-8703-65f9a5f8229d", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 321, DateTimeKind.Unspecified).AddTicks(6304), new TimeSpan(0, 7, 0, 0, 0)), null, null, "alicejohnson@example.com", false, "Alice Johnson", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 321, DateTimeKind.Unspecified).AddTicks(6304), new TimeSpan(0, 7, 0, 0, 0)), false, null, null, "ALICEJOHNSON", null, null, "$2a$11$CFWp2vKZ9Orwwhub2nIwfeySz4PwsMzbl.CATkYB2y9SDURQ/.9Ta", null, false, false, "vet3", null },
                    { 6, 0, "123 Main St", null, null, "899895d3-5340-4132-afad-dc235e3b9578", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 453, DateTimeKind.Unspecified).AddTicks(4705), new TimeSpan(0, 7, 0, 0, 0)), null, null, "quangtdmse171391@example.com", false, "Tran Dinh Minh Quang", null, new DateTimeOffset(new DateTime(2024, 11, 13, 12, 34, 57, 453, DateTimeKind.Unspecified).AddTicks(4705), new TimeSpan(0, 7, 0, 0, 0)), false, null, null, "CUS1", null, null, "$2a$11$rhSBKJb.u27Kv9z7cB9eS.o6si8LftN.d24dXITt44K9WwEOvpN3q", "0123456789", false, false, "cus1", null }
                });
